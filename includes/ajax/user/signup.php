<?php
	...
	function performRequest(){
		...
		try
		{
			$statement = "	INSERT INTO ".Config::get('table_prefix')."signup
							(`name`, `email`,  `company` , `password`) VALUES (:name, :email, :company, :password);";
			...
			Session::set('signup', 1);
			$return_msg['success'] = "Thank you for SignUp.";
