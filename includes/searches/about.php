	...
	function performSearch($params)
	{
		...
		try
		{
			...
			else
			{
				...
				$return_msg .= 		'<th></th>';
				//$return_msg .=        '<th>Date Posted</th>';
				$return_msg .=        '<th>Title</th>';
				//$return_msg .=        '<th></th>';
				$return_msg .= 	'</tr>';
				...
				//	$date_posted = date("d M Y", strtotime($data['date_posted']));
					...
					//$return_msg .=    '<td class="strong" data-id="Date Posted">'.$date_posted.'</td>';
					$return_msg .=    '<td class="strong" data-id="Title">'.$title.'</td>';
