				...
				<div class="col col-80 content-col">
					...
					<form method="post" enctype="multipart/form-data">
							...
							<div class="img-preview">  
								<?php
									...
									else
									{
										...
										echo '<img src="'.Config::get('absolute_url').Config::get('director_images').Input::get("img").'" alt="Item Image">';
						...
						<div class="btn_container">
							<button class="btn" name="submit" value="submit">Add AboutInfo</button>
						</div>
					</form>
